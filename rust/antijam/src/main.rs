...
#[allow(dead_code)]
fn task_2(i: f32, c1: f32, c0: f32, q: f32, bits: u32, n: u32) -> (f32, f32, f32, f32, f32, f32) {
    let p = 1. - q;
...
fn main() {
    ...
    // task 2
    let r2: (f32, f32, f32, f32, f32, f32) = task_2(3.4, 0.02, 2., 0.0001, 1000000000, 1);
    println!("Amount of all data: {}", r2.0);
    println!("Amount of all correct data: {}", r2.1);
    println!("Amount of all wrong data: {}", r2.2);
    println!("Payment: {}", r2.3);
    println!("Penalty: {}", r2.4);
    println!("Profit: {}", r2.5);
}
